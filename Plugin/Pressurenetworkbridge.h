...
namespace PNBridge
{
    ...
    private:
        // Script builders
        void writeHeader(std::wostringstream& f, const NetworkDef& net);
        void writeSetCurrentLayer(std::wostringstream& f, const std::wstring& layer);
        void writeCreateNetwork(std::wostringstream& f, const NetworkDef& net);
        void writeAddJunction(std::wostringstream& f, const PipeNode& node);
        void writeAddHydrant(std::wostringstream& f, const PipeNode& node);
        void writeAddValve(std::wostringstream& f, const PipeNode& node);
        void writeAddPipe(std::wostringstream& f, const PipeSeg& seg,
            const NetworkDef& net);
