...
//       // Execute via LISP - bypasses callback restrictions
//        std::wstring lisp = L"(command \"SCRIPT\" \"" + fwdLoader + L"\")";
//        struct resbuf* rb = acutBuildList(RTSTR, lisp.c_str(), RTNONE);
//        acedEval(rb, nullptr);
//        acutRelRb(rb);
//        acutPrintf(L"  Script queued via LISP.\n");
//        return {};
//    }
//
//    // ─────────────────────────────────────────────────────────────
